...
class Project < ActiveRecord::Base
  ...
  validates_numericality_of :online_days, less_than_or_equal_to: 180, greater_than: 60,
  ...
  def pledged
    puts " enter in pledged "
    puts project_total.try(:pledged)
    puts " **** ---- ***** ------- "
