...
--
-- Name: img_thumbnail(projects, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION img_thumbnail(projects, size text) RETURNS text
    LANGUAGE sql STABLE
    AS $_$
          SELECT
...
CREATE VIEW projects AS
 SELECT p.id AS project_id,
    ...
    p.online_date,
    p.recommended,
    public.img_thumbnail(p.*, 'large'::text) AS project_img,
...
CREATE VIEW team_members AS
 SELECT u.id,
    u.name,
    public.profile_img_thumbnail(u.*) AS img,
...
CREATE RULE "_RETURN" AS
    ...
    public.remaining_time_json(p.*) AS remaining_time,
    ( SELECT json_build_object('id', u.id, 'name', u.name) AS json_build_object
           FROM public.users u
          WHERE (u.id = p.user_id)) AS "user",
   ...
   FROM (((public.projects p
     ...
     LEFT JOIN reward_details rd ON ((rd.project_id = p.id)))
     LEFT JOIN public.project_notifications pn ON ((pn.project_id = p.id)))
  GROUP BY p.id, pt.progress, pt.pledged, pt.total_contributions, p.state, p.expires_at, p.sent_to_analysis_at, pt.total_payment_service_fee;
...
INSERT INTO schema_migrations (version) VALUES ('20150729110132');

INSERT INTO schema_migrations (version) VALUES ('20150803170927');

INSERT INTO schema_migrations (version) VALUES ('20150804173736');

INSERT INTO schema_migrations (version) VALUES ('20150804212727');

INSERT INTO schema_migrations (version) VALUES ('20150807164942');

INSERT INTO schema_migrations (version) VALUES ('20150807183831');

INSERT INTO schema_migrations (version) VALUES ('20150811194423');

INSERT INTO schema_migrations (version) VALUES ('20150813150835');

INSERT INTO schema_migrations (version) VALUES ('20150813193432');

INSERT INTO schema_migrations (version) VALUES ('20150817134444');

INSERT INTO schema_migrations (version) VALUES ('20150819150242');

INSERT INTO schema_migrations (version) VALUES ('20150821074156');

INSERT INTO schema_migrations (version) VALUES ('20150824141759');

INSERT INTO schema_migrations (version) VALUES ('20150825193026');

INSERT INTO schema_migrations (version) VALUES ('20150828040317');

INSERT INTO schema_migrations (version) VALUES ('20150902210721');

INSERT INTO schema_migrations (version) VALUES ('20150903152542');

INSERT INTO schema_migrations (version) VALUES ('20150904025633');

INSERT INTO schema_migrations (version) VALUES ('20150904161626');

INSERT INTO schema_migrations (version) VALUES ('20150911133439');

INSERT INTO schema_migrations (version) VALUES ('20150911145304');
